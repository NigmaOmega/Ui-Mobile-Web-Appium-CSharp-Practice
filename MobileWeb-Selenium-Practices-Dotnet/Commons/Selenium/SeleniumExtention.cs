using MobileWeb_Selenium_Practices_Dotnet.Commons.Selenium;
...
namespace SeleniumPractice
{
    public static class SeleniumExtention
    {
        ...
        public static IWebElement WaitForNotVisible(this IWebDriver driver, By by, TimeSpan timeOut)
        {
            ...
            wait.Until(OpenQA.Selenium.Support.UI.ExpectedConditions.InvisibilityOfElementLocated(by));
        ...
        public static Javascripts Javascripts(this IWebDriver driver) {
            return new Javascripts(driver);
        }
    }
}
